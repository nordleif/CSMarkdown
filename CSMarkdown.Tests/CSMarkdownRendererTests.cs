...
namespace CSMarkdown.Tests
{
    ...
    public class CSMarkdownRendererTests
    {
        ...
        [TestCase("markdown_table_with_options.smd", RenderOutput.Html)]
        [TestCase("markdown_table_with_options.smd", RenderOutput.Pdf)]
        ...
        [TestCase("markdown_5_legends_using_readTags.smd", RenderOutput.Html)]
