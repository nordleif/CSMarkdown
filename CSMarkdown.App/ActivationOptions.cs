...
namespace CSMarkdown.App
{
    internal class ActivationOptions
    {
        ...
        [ValueArgument(typeof(string), 'p', LongName = "parameters", Description = "Holds the parameters for the report. If the argument with parameters contains whitespaces, then use \"[parameters]\" to encapsulate.", Example = "from=2016-11-25, to=2016-11-28, tag=NameTag")]
